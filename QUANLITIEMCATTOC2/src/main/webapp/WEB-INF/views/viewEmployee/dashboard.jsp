...
<body>
               ...
               <ul class="navbar-nav">
                   ...
                   <li class="d-flex px-3">
                       <a href="productEmployee/index/${usernameEmployee }.htm" class="nav-link active py-0">
                           <span class="me-2"><i class="bi bi-person-fill-gear fw-bolder fs-4"></i></span>
                           <span class="fs-4 fw-bolder">Nhân Viên</span>
                       </a>
                   </li>
                   ...
                   <li>
                       ...
                       <div class="collapse" id="layouts">
                           <ul class="navbar-nav ps-3">
                               <li><a role="button" href="productEmployee/index/${usernameEmployee }.htm" class="nav-link px-3"> <span class="me-2"><i class="bi bi-speedometer2"></i></span>
                                       <span>Danh sách sản phẩm</span>
                                   </a> 
<%--                                    <a role="button" href="product/insert/${usernameEmployee }.htm" class="nav-link px-3"> <span class="me-2"><i --%>
<!--                                                class="bi bi-folder-plus"></i></span> <span></span> -->
<!--                                    </a></li> -->
                           </ul>
                       </div>
                   </li>
                   ...
                   <li>
                    ...
                    <div class="collapse" id="layouts1">
                        <ul class="navbar-nav ps-3">
                            <li><a role="button" href="serviceEmployee/index/${usernameEmployee }.htm" class="nav-link px-3"> <span class="me-2"><i class="bi bi-speedometer2"></i></span>
                                    <span>Danh sách dịch vụ</span>
                                </a> 
<%--                                 <a role="button" href="service/insert/${usernameEmployee }.htm" class="nav-link px-3"> <span class="me-2"><i --%>
<!--                                             class="bi bi-folder-plus"></i></span> <span></span> -->
<!--                                 </a></li> -->
                        </ul>
                    </div>
