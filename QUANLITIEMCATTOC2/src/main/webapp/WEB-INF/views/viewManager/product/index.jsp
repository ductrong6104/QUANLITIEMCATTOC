		...
		<tbody>
			<c:forEach var="p" items="${products }">
				<tr>
					...
					<td><a role="button" href="product/update/${p.maSanPham }.htm"><i class="fa fa-pencil" aria-hidden="true"></i>Sửa</a></td>
					<td><a role="button" href="product/delete/${p.maSanPham }.htm"><i class="fa fa-eraser" aria-hidden="true"></i>Xóa</a></td>
				</tr>
			</c:forEach>
		</tbody>
